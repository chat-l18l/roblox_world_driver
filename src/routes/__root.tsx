...
import { PreviewHostBridge } from "@/components/preview-host-bridge.tsx";
import { AppShell } from "@/components/AppShell.tsx";
import appCss from "../styles.css?url";

const APP_NAME = "Wereldpost";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Educatieve koeriersgame: leer topografie door pakketten te bezorgen. Architectuurprototype voor een latere Roblox-port.",
      },
