/** Geographic knowledge model — plain data, no behavior.
 *  Maps 1:1 to a Luau ModuleScript under ReplicatedStorage.Shared.Model.
 */

export type RegionId = "lage-landen" | "west-europa" | "europa" | "wereld";
...
export const COUNTRIES: Country[] = [
  ...
  },
  {
    ...
    nameEn: "South Africa",
    capital: "Pretoria",
    language: "Afrikaans, Engels, Zoeloe",
    river: "Oranjerivier",
    airport: "JNB",
    continent: "Afrika",
    region: "wereld",
  ...
  },
  {
    ...
    nameEn: "Nigeria",
    capital: "Abuja",
    language: "Engels, Hausa, Yoruba, Igbo",
    river: "Niger",
    airport: "ABV",
    continent: "Afrika",
    region: "wereld",
