...
import { d as learnerStage, f as playableCountries, i as REGION_LABEL, l as countryByIso, n as COUNTRY_BY_NUMERIC, o as STAGE_HINT, s as STAGE_LABEL, t as COUNTRIES, u as highestUnlockedRegion } from "./curriculum-BNjmyCpA.mjs";
import { a as haversineKm, c as stageOf, i as destCountry, l as tickSession, n as bearingDeg, o as progressInRegion, r as createSession, s as reduceSession } from "./session-CRvRAKAG.mjs";
...
import { n as path_default, t as mercator_default } from "../_libs/d3-geo.mjs";
import { t as feature_default } from "../_libs/topojson-client.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/speel-C98hbKjN.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var KEY = "wereldpost.save.v1";
var SAVE_VERSION = 1;
function toSave(s) {
	return {
...
function sfxDepart() {
	beep(220, .12, "triangle", .04);
	beep(330, .18, "sine", .03);
}
function sfxArrive() {
	beep(392, .1, "square", .03);
	beep(523, .16, "triangle", .04);
}
function sfxOk() {
	beep(523, .12, "sine", .045);
	beep(784, .2, "sine", .035);
}
function sfxBad() {
	beep(180, .2, "sawtooth", .04);
}
...
function attachInput(target, input) {
	const onDown = (e) => {
	...
	const readStick = () => {
		...
		const scale = (Math.min(1, m) - .15) / .85 / m;
		const x = dx * scale;
		input.touch = {
			throttle: clamp$1(-(dy * scale), -1, 1),
			steer: clamp$1(-x, -1, 1)
		};
	};
	const onPtrDown = (e) => {
...
function sampleDrive(input) {
	...
	return {
		throttle: clamp$1(throttle, -1, 1),
		steer: clamp$1(steer, -1, 1)
	};
}
...
var countries_110m_default = {
	...
	transform: {
		"scale": [.0036000360003600037, .0016925586033320105],
		"translate": [-180, -85.60903777459771]
	}
};
var collection = feature_default(countries_110m_default, countries_110m_default.objects.countries);
function createCam(s) {
	return {
		lat: s.vehicle.lat,
		lon: s.vehicle.lon,
...
function stepCam(cam, s, dt, w, h) {
	const dest = s.mission ? COUNTRIES.find((c) => c.iso === s.mission?.destIso) : void 0;
	...
	let targetZoom = s.vehicle.craft === "plane" ? Math.max(280, w * .28) : Math.max(900, w * .95);
	if (dest) {
		leadLat = s.vehicle.lat * .62 + dest.lat * .38;
		leadLon = s.vehicle.lon * .62 + dest.lon * .38;
		const probe = mercator_default().scale(1e3).center([s.vehicle.lon, s.vehicle.lat]).translate([0, 0]);
		...
		if (a && b) {
			...
			targetZoom = clamp(1e3 * (Math.min(w, h) * .46 / dist), 520, 2800);
		}
	}
...
function addTrauma(cam, amount) {
	return {
		...cam,
		trauma: Math.min(1, cam.trauma + amount)
	};
}
function renderWorld(ctx, s, cam, cssW, cssH, now) {
	ctx.save();
	...
	const projection = mercator_default().scale(cam.zoom).center([cam.lon, cam.lat]).translate([cssW / 2 + ox, cssH / 2 + oy]);
	const path = path_default(projection, ctx);
...
function drawCraft(ctx, x, y, heading, craft) {
	ctx.save();
	ctx.translate(x, y);
	ctx.rotate(heading);
	if (craft === "plane") {
...
function GameScreen() {
	...
	const sessionRef = (0, import_react.useRef)(bootSession());
	const camRef = (0, import_react.useRef)(createCam(sessionRef.current));
	const inputRef = (0, import_react.useRef)(createInput());
	const [ui, setUi] = (0, import_react.useState)(() => snap(sessionRef.current));
	const [started, setStarted] = (0, import_react.useState)(false);
	const [stick, setStick] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		...
		const loop = (now) => {
			...
			while (acc >= step) {
				...
				if (s.state === "transit") s = tickSession(s, sampleDrive(inputRef.current), step);
				sessionRef.current = s;
				camRef.current = stepCam(camRef.current, s, step, wrap.clientWidth || 800, wrap.clientHeight || 600);
				acc -= step;
			}
			...
			if (s.state !== prevState) {
				...
				if (s.state === "quiz") {
					sfxArrive();
					camRef.current = addTrauma(camRef.current, .45);
				}
				if (s.state === "debrief") {
					if (s.lastAnswer === "correct") sfxOk();
					else sfxBad();
					persistSave(s);
					camRef.current = addTrauma(camRef.current, .25);
				}
				prevState = s.state;
				setUi(snap(s));
			}
			...
			if (ctx) {
				...
				renderWorld(ctx, s, camRef.current, w, h, now / 1e3);
			}
	...
	const send = (e) => {
		...
		if (sessionRef.current.state === "debrief" || sessionRef.current.state === "hub") persistSave(sessionRef.current);
	};
	const start = () => {
		unlockAudio();
		let s = sessionRef.current;
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pointer-events-auto rounded-[var(--radius-md)] border border-border bg-bg/90 px-3 py-2",
					...
					className: "pointer-events-auto flex flex-col items-end gap-1 rounded-[var(--radius-md)] border border-border bg-bg/90 px-3 py-2",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						ui.state === "transit" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
			...
			ui.state === "transit" && dest && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "pointer-events-none absolute inset-x-0 top-16 flex justify-center px-3",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 rounded-[var(--radius-lg)] border border-border bg-bg/92 px-4 py-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FlagBars, {
						country: dest,
						className: "h-5 w-8"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm font-medium leading-tight",
						children: [dest.capital, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-muted",
							children: [" · ", dest.nameNl]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "pointer-events-none absolute bottom-3 left-3 right-3 flex items-end justify-between gap-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "max-w-[14rem] text-[11px] text-fg/80 sm:max-w-xs",
						children: [
					...
					stick && ui.state === "transit" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none mb-2 ml-1 size-28 rounded-full border border-fg/25 bg-bg/30" }),
			...
			!started && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Overlay, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Je bent koerier. Elke rit leert je een land, hoofdstad, taal, rivier en luchthaven. WASD sturen: A is links, D is rechts."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					className: "mt-5 w-full sm:w-auto",
					onClick: start,
					size: "lg",
					children: "Start de eerste rit"
				})
			] }),
			started && ui.state === "brief" && dest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Overlay, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
					className: "mt-5 grid grid-cols-2 gap-x-6 gap-y-2 text-sm",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fact, {
							k: "Afstand",
							v: ui.km ? `${Math.round(ui.km)} km` : "—"
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 text-sm text-muted",
					children: ui.craft === "plane" ? "Lange afstand: je vliegt. W is gas, A/D koers." : "W gas, S rem, A links, D rechts. Rijd naar de stempel op de kaart."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					className: "mt-6",
			...
			ui.state === "quiz" && ui.quiz && dest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Overlay, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-xs uppercase tracking-[0.18em] text-muted",
					children: "kennischeck"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 font-display text-2xl tracking-tight",
					children: ui.quiz.prompt
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-5 grid gap-2",
					children: ui.quiz.options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						variant: "outline",
				...
				ui.lastAnswer === "wrong" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-stamp",
					children: "Nog een poging."
				})
			] }),
			ui.state === "debrief" && dest && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Overlay, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-xs uppercase tracking-[0.18em] text-muted",
					children: ui.lastAnswer === "correct" ? "bezorgd" : "afgegeven"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 font-display text-3xl tracking-tight",
					children: ui.lastAnswer === "correct" ? "Goed onthouden." : "Bijna."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Taal: ", dest.language] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Rivier: ", dest.river] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Luchthaven: ", dest.airport] })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					className: "mt-6",
					onClick: nextPackage,
					children: "Volgend pakket"
				})
			] }),
			ui.state === "paused" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Overlay, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "font-display text-3xl tracking-tight",
				children: "Pauze"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				className: "mt-6",
				onClick: () => send({ type: "resume" }),
				children: "Verder rijden"
			})] })
		]
	});
}
function Overlay({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "absolute inset-0 z-10 flex items-start justify-center overflow-y-auto bg-fg/25 p-4 pb-20 pointer-events-auto sm:items-center sm:pb-4",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: cn("my-4 w-full max-w-md rounded-[calc(var(--radius-md)+16px)] border border-border bg-bg p-5 shadow-sm sm:my-0 sm:p-8"),
			children
		})
	});
}
